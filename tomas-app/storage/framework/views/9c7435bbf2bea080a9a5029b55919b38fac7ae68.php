...
<div style="display:grid;grid-template-columns:280px 1fr;gap:16px;align-items:start">
    ...
    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:14px;overflow:hidden">
        ...
        <form action="<?php echo e(route('admin.layanan.store')); ?>" method="POST" style="padding:18px">
            <?php echo csrf_field(); ?>
            <div style="margin-bottom:14px">
                ...
                <input type="text" name="nama_layanan" value="<?php echo e(old('nama_layanan')); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?><p style="color:#ef4444;font-size:11px;margin-top:4px"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:14px;overflow:hidden">
        <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 18px;border-bottom:1px solid #f1f5f9">
            ...
            <span style="background:#eff6ff;color:#2563eb;font-size:11px;font-weight:600;padding:3px 10px;border-radius:20px"><?php echo e($layanan->count()); ?> total</span>
        </div>
        <div>
            ...
            <?php $cnt = \App\Models\Tukang::where('kategori',$l->nama_layanan)->count(); ?>
            <div style="padding:13px 18px;border-bottom:1px solid #f8fafc" onmouseover="this.style.background='#fafbfc'" onmouseout="this.style.background=''">
                <div style="display:flex;align-items:center;justify-content:space-between;gap:12px" id="row-<?php echo e($l->id_layanan); ?>">
                    <div style="display:flex;align-items:center;gap:10px;flex:1;min-width:0">
                        ...
                        <div>
                            <span style="font-size:13px;font-weight:600;color:#111827"><?php echo e($l->nama_layanan); ?></span>
                            <span style="font-size:11px;color:#9ca3af;margin-left:6px">#<?php echo e($l->id_layanan); ?></span>
                            <div style="font-size:11px;color:#6b7280;margin-top:1px"><?php echo e($cnt); ?> provider terdaftar</div>
                        </div>
                    </div>
                    <div style="display:flex;align-items:center;gap:6px;flex-shrink:0">
                        <button onclick="startEdit(<?php echo e($l->id_layanan); ?>, '<?php echo e(addslashes($l->nama_layanan)); ?>')"
                        ...
                        <form action="<?php echo e(route('admin.layanan.delete', $l->id_layanan)); ?>" method="POST" style="display:inline"
                              onsubmit="return confirm('Hapus layanan <?php echo e(addslashes($l->nama_layanan)); ?>?')">
                ...
                <div id="edit-<?php echo e($l->id_layanan); ?>" style="display:none;margin-top:10px">
                    <form action="<?php echo e(route('admin.layanan.update', $l->id_layanan)); ?>" method="POST" style="display:flex;gap:8px">
                        <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                        <input type="text" name="nama_layanan" id="inp-<?php echo e($l->id_layanan); ?>" value="<?php echo e($l->nama_layanan); ?>" required
                        ...
                        <button type="button" onclick="cancelEdit(<?php echo e($l->id_layanan); ?>)"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel web app\tomas-app\resources\views\admin\layanan\index.blade.php ENDPATH**/ ?>