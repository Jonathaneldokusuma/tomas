...
<div class="page-content bg-gray-50">
    ...
    <div class="flex items-center gap-3 px-4 pt-5 pb-3 bg-white border-b border-gray-100">
        <a href="<?php echo e(route('riwayat')); ?>" class="w-9 h-9 rounded-full flex items-center justify-center bg-gray-100">
    ...
    <div class="px-4 pt-6">
        ...
        <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="font-bold text-navy"><?php echo e($order->tukang->nama ?? '-'); ?></div>
                    <div class="text-xs text-gray-500 mt-0.5"><?php echo e($order->layanan->nama_layanan ?? '-'); ?></div>
                </div>
            </div>
        </div>
        ...
        <!-- Form -->
        <form action="<?php echo e(route('review.store', $order->id_order)); ?>" method="POST">
            <?php echo csrf_field(); ?>
                ...
                <div class="flex justify-center gap-3" id="star-container">
                    ...
                    <label class="cursor-pointer star-label" data-value="<?php echo e($i); ?>">
                        <input type="radio" name="rating" value="<?php echo e($i); ?>"
                               class="hidden"
                               <?php echo e(old('rating', 5) == $i ? 'checked' : ''); ?>>
                        <i class="fas fa-star text-4xl <?php echo e(old('rating', 5) >= $i ? 'text-yellow-400' : 'text-gray-200'); ?> transition-colors"
                           id="star-<?php echo e($i); ?>"></i>
                    </label>
                    <?php endfor; ?>
                </div>
...
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-2 text-center"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 mb-6">
                ...
                ><?php echo e(old('komentar')); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel web app\tomas-app\resources\views\review\create.blade.php ENDPATH**/ ?>