<?php $__env->startSection('title', 'Chat - ' . $tukang->nama); ?>
...
<div class="page-content bg-gray-50" id="chat-page">
    ...
    <div class="flex items-center gap-3 px-4 pt-5 pb-3 bg-white border-b border-gray-100 sticky top-0 z-10">
        <a href="<?php echo e(route('chat')); ?>" class="w-9 h-9 rounded-full flex items-center justify-center bg-gray-100">
        ...
        <div class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center flex-none overflow-hidden">
            <?php if($tukang->foto): ?>
            <img src="<?php echo e(Storage::url($tukang->foto)); ?>" alt="" class="w-full h-full object-cover">
            <?php else: ?>
            <i class="fas fa-user text-gray-400 text-lg"></i>
            <?php endif; ?>
        </div>
        <div class="flex-1 min-w-0">
            <div class="font-bold text-navy text-sm leading-tight"><?php echo e($tukang->nama); ?></div>
            <div class="text-xs <?php echo e($tukang->status_aktif ? 'text-green-500' : 'text-gray-400'); ?> font-medium">
                <?php echo e($tukang->status_aktif ? '● Online' : '● Offline'); ?>
    ...
    <div id="chat-body" class="px-4 pt-4 space-y-3">
        ...
        <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($msg->dari_user): ?>
            
            <div class="flex justify-end">
                <div class="max-w-[75%]">
                    <div class="bubble-user text-sm px-4 py-2.5 leading-snug"><?php echo e($msg->pesan); ?></div>
            ...
            <div class="flex gap-2 items-end">
                ...
                <div class="max-w-[75%]">
                    <div class="bubble-tukang text-sm px-4 py-2.5 leading-snug"><?php echo e($msg->pesan); ?></div>
    ...
    <div class="chat-input-bar">
        <form action="<?php echo e(route('chat.send', $tukang->id_tukang)); ?>" method="POST"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel web app\tomas-app\resources\views\chat\show.blade.php ENDPATH**/ ?>