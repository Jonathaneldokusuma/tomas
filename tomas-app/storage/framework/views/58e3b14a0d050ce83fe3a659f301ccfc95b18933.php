...
<div class="w-full max-w-sm mx-4">
    ...
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div class="px-8 pt-10 pb-6 text-center" style="background:linear-gradient(160deg,#0f1c35 0%,#1a2b4a 60%,#1e3a8a 100%)">
            <img src="<?php echo e(asset('images/tomas-logo.png')); ?>" alt="Tomas" class="h-20 object-contain mx-auto mb-2">
        ...
        <div class="px-8 py-8">
            ...
            <div class="text-center mt-6">
                <a href="<?php echo e(route('home')); ?>" class="text-xs text-gray-400 hover:text-gray-600">
...
<?php /**PATH D:\laravel web app\tomas-app\resources\views\admin\login.blade.php ENDPATH**/ ?>