        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex-1">
                <div class="text-white font-bold text-xl">
                    {{ session('user_nama') ?? 'Username' }}
                </div>
                <div class="text-blue-100 text-xs">{{ session('user_hp') ?? '+62 xxx' }}</div>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden mb-4">
            ...
            <a href="#" class="flex items-center justify-between px-4 py-3.5 border-t border-gray-50 hover:bg-gray-50">
                <div class="flex items-center gap-3">
                    <i class="{{ $menu['icon'] }} {{ $menu['color'] }} w-4 text-center"></i>
                    <span class="text-sm text-navy">{{ $menu['label'] }}</span>
                </div>
