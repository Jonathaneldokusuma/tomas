...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _load() async {
    try {
      final data = await ApiService.getChatMessages(widget.idTukang);
      setState(() {
  ...
  Future<void> _send() async {
    ...
    try {
      final msg = await ApiService.sendMessage(widget.idTukang, text);
      setState(() {
        _messages.add(msg);
        _sending = false;
      });
            ...
            child: _loading
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      final fromUser = m['dari_user'] == true;
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: fromUser ? const Color(0xFF1A2B47) : Colors.white,
