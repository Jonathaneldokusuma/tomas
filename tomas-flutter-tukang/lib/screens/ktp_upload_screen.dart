...
class _KtpUploadScreenState extends State<KtpUploadScreen> {
  ...
  void _showOptions(bool isKtp) {
    showModalBottomSheet(
      ...
      builder: (_) => SafeArea(child: Column(mainAxisSize: MainAxisSize.min, children: [
        ListTile(leading: const Icon(Icons.camera_alt, color: _kBlue), title: const Text('Ambil Foto'), onTap: () { Navigator.pop(context); _pickImage(isKtp, camera: true); }),
        ListTile(leading: const Icon(Icons.photo_library, color: _kBlue), title: const Text('Pilih dari Galeri'), onTap: () { Navigator.pop(context); _pickImage(isKtp); }),
      ])),
    );
  }
  ...
  void _submit() async {
    if (_ktpImage == null || _selfieImage == null) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Wajib upload foto KTP & selfie!')));
      return;
    }
    ...
    if (mounted) Navigator.pushReplacementNamed(context, '/waiting-verification');
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Upload Dokumen', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF1F2937))),
              const SizedBox(height: 6),
              const Text('Foto harus jelas agar proses verifikasi cepat.', style: TextStyle(fontSize: 13, color: Colors.grey)),
              const SizedBox(height: 24),
              _uploadCard('Foto KTP', 'Pastikan nomor KTP dan wajah jelas', Icons.credit_card, _ktpImage, () => _showOptions(true)),
              const SizedBox(height: 16),
              _uploadCard('Selfie dengan KTP', 'Pegang KTP di depan wajah kamu', Icons.face, _selfieImage, () => _showOptions(false)),
              ...
              Container(
                ...
                child: const Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  SizedBox(width: 10),
                  Expanded(child: Text('Verifikasi biasanya 1×24 jam. Foto tidak blur & tidak terpotong.', style: TextStyle(fontSize: 12, color: Color(0xFF1D4ED8)))),
                ]),
              ),
              const SizedBox(height: 28),
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: (_loading || _ktpImage == null || _selfieImage == null) ? null : _submit,
                  ...
                  child: _loading
                      ...
                      : const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          Text('Kirim untuk Verifikasi', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                          SizedBox(width: 8),
  ...
  Widget _uploadCard(String label, String subtitle, IconData icon, File? image, VoidCallback onTap) {
      ...
      child: Container(
        ...
        child: image == null
            ? Padding(
                ...
                child: Row(children: [
                  Container(width: 48, height: 48, decoration: BoxDecoration(color: const Color(0xFFEFF6FF), borderRadius: BorderRadius.circular(12)), child: Icon(icon, color: _kBlue, size: 26)),
            ...
            : ClipRRect(
                ...
                child: Stack(children: [
                  Image.file(image, height: 170, width: double.infinity, fit: BoxFit.cover),
                  Positioned(bottom: 8, right: 8, child: Container(
                    ...
                    child: const Row(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      SizedBox(width: 4),
                      Text('Ganti', style: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.bold)),
                    ]),
                  )),
