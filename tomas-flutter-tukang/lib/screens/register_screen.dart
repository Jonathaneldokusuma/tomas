...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _register() async {
    ...
    if (nama.isEmpty || username.isEmpty || password.isEmpty ||
        noHp.isEmpty || noKtp.isEmpty || alamat.isEmpty) {
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child:
                      const Icon(Icons.construction, color: Colors.white, size: 38),
                ),
              ),
              ...
              const Center(
                  child: Text('Isi data diri lengkap untuk mendaftar',
              ...
              Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 14),
                      _label('Username *'),
                      _field(_usernameCtrl, 'Buat username unik',
                          Icons.alternate_email),
                      const SizedBox(height: 14),
                      _label('No. HP / WhatsApp *'),
                      _field(_noHpCtrl, 'Contoh: 08123456789',
                          Icons.phone_outlined,
                          type: TextInputType.phone),
                      const SizedBox(height: 14),
                      _label('Nomor KTP (NIK) *'),
                      _field(_noKtpCtrl, '16 digit nomor KTP',
                      ...
                      TextField(
                        ...
                        decoration:
                            _dec('Min. 6 karakter', Icons.lock_outline).copyWith(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        maxLines: 3,
                        decoration: _dec('Jl. Contoh No. 1, Kota, Provinsi',
                            Icons.home_outlined),
                      ),
                      const SizedBox(height: 16),
