...
class PaymentScreen extends StatefulWidget {
  ...
  const PaymentScreen({
    ...
    // snapUrl kept for backward compat but unused
    String? snapUrl,
  });
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  Future<void> _konfirmasi() async {
    ...
    try {
      await ApiService.bayar(widget.idOrder, ref);
      if (!mounted) return;
      _showSuccess();
    } catch (e) {
      if (mounted) {
        ...
        actions: [
          ElevatedButton(
            ...
            onPressed: () {
              ...
              Navigator.pop(context, true); // return paid=true
            },
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Rp${widget.jumlah.toStringAsFixed(0)}',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _step(
                    '3',
                    'Masukkan nomor referensi di bawah dan konfirmasi',
                  ),
                ],
              ),
            ),
