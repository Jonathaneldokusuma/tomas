...
class _KonfirmasiScreenState extends State<KonfirmasiScreen> {
  ...
  String get _tanggalStr {
    return '${_tanggal.year}-${_tanggal.month.toString().padLeft(2, '0')}-${_tanggal.day.toString().padLeft(2, '0')}';
  }

  String get _jamStr {
    return '${_jam.hour.toString().padLeft(2, '0')}:${_jam.minute.toString().padLeft(2, '0')}';
  }
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    _alamatChip(
                      'Rumah',
                      'Jl. Melati No. 12, RT 03/04, Surakarta',
                    ),
                    _alamatChip(
                      'Kantor',
                      'Jl. Slamet Riyadi No. 45, Surakarta',
                    ),
                    _alamatChip('Lainnya', ''),
                  ],
                ),
          ...
          _card(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                const Text(
                  'Opsional — ceritakan lebih detail kebutuhan kamu',
                      ...
                      .map(
                        (tag) => GestureDetector(
                          onTap: () {
                            ...
                            _deskripsiCtrl.text = cur.isEmpty
                                ? tag
                                : '$cur, $tag';
                          },
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                const Icon(Icons.add, size: 12, color: _kBlue),
                                const SizedBox(width: 4),
                                Text(
                                  tag,
                                  style: const TextStyle(
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText:
                        'Contoh: Perbaikan keran bocor di dapur, perlu diganti...',
                    hintStyle: const TextStyle(
                      color: Colors.grey,
                      fontSize: 12,
                    ),
            ...
            Expanded(
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: bold ? _kBlue : const Color(0xFF1F2937),
                ),
              ),
            ),
          ],
