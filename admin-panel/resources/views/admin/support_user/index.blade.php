...
<div style="padding:24px">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-bottom:18px">
        ...
        <div style="background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:14px 16px"><div style="font-size:12px;color:#6b7280">Pesan User</div><div style="font-size:22px;font-weight:800;color:#2563eb">{{ $threads->sum('from_user') }}</div></div>
